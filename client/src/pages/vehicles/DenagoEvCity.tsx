...
export default function DenagoEvCity() {
  return (
    <>
      <SEOHead 
        title="DENAGO EV CITY Personal Transportation Vehicle"
        ...
        canonicalUrl="https://tigonptv.com/vehicles/denago-ev-city"
      ...
      <VehicleSchema 
        ...
        url="https://tigonptv.com/vehicles/denago-ev-city"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a href="https://tigonptv.com/denago-ev/city/" target="_blank" rel="noopener noreferrer">
                    <Button size="lg" className="w-full sm:w-auto bg-theme-orange hover:opacity-90 text-white shadow-lg">
                      View More Details
                    </Button>
                  </a>
