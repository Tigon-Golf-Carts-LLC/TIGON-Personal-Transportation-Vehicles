...
import vehicleImage from "@assets/EVOLUTIONTURFMAN1000_1751893159006_1753135437836.jpg";
  ...
  return (
    <>
      <SEOHead 
        ...
        description="Heavy-duty commercial utility personal transportation vehicle for landscaping and maintenance work. Maximum 1,000 lbs payload with professional-grade construction. Call 1-844-844-6638."
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Heavy-duty commercial utility personal transportation vehicle designed for professional landscaping and maintenance work. Maximum 1,000 lbs payload with professional-grade construction.
                </p>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Maximum Payload</h3>
                      <p className="text-gray-600">1,000 lbs payload capacity handles heavy equipment, materials, and supplies.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Reinforced frame and commercial-grade components built for continuous operation.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">40-60 mile range provides all-day operation for demanding commercial schedules.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Built for professional landscaping operations and commercial property maintenance.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <span className="drop-shadow-lg">40-60 miles</span>
                      </div>
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        <div className="flex items-center gap-3">
