...
export default function EvolutionD5Ranger4() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION D5-RANGER 4 Neighborhood Electric Vehicle"
        description="Four-passenger neighborhood electric vehicle with rugged construction and reliable performance. Perfect for everyday transportation and adventures. Call 1-844-844-6638."
        keywords="EVOLUTION D5 Ranger 4, 4-passenger neighborhood electric vehicle, rugged NEV, reliable performance, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonnev.com/vehicles/evolution-d5-ranger-4"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Reliable four-passenger neighborhood electric vehicle with rugged construction. Perfect for everyday transportation needs with proven Ranger durability.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    ...
                    <div className="drop-shadow-lg">Rugged Frame</div>
                  </div>
                </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D5-RANGER 4 Neighborhood Electric Vehicle"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">4-Passenger Seating</h3>
                      <p className="text-gray-600">Comfortable seating for four adults with ample legroom and support.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Built with durable materials and reinforced frame for lasting reliability.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Settings className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Proven Performance</h3>
                      <p className="text-gray-600">Reliable electric motor delivers consistent power for daily use.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Award className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Ranger Quality</h3>
                      <p className="text-gray-600">Part of the trusted Ranger series known for durability and value.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Proven Reliability, Rugged Performance
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Neighborhood Electric Vehicles today for your EVOLUTION D5-RANGER 4.
            </p>
