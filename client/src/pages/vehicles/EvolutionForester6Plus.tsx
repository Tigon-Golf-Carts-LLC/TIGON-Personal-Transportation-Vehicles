...
export default function EvolutionForester6Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION FORESTER 6 PLUS Neighborhood Electric Vehicle"
        description="Six-passenger premium utility neighborhood electric vehicle with heavy-duty features and rugged construction. Built for work and recreation. Call 1-844-844-6638."
        keywords="EVOLUTION FORESTER 6 PLUS, utility neighborhood electric vehicle, 6-passenger, heavy-duty, work vehicle, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonnev.com/vehicles/evolution-forester-6-plus"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Six-passenger premium utility neighborhood electric vehicle with heavy-duty features and rugged construction. Perfect for work crews, resorts, and properties requiring utility transportation.
                </p>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION FORESTER 6 PLUS Neighborhood Electric Vehicle"
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Neighborhood Electric Vehicles today for your EVOLUTION FORESTER 6 PLUS.
            </p>
