            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D5-MAVERICK 2+2 Personal Transportation Vehicle"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">2+2 Seating Configuration</h3>
                      <p className="text-gray-600">Unique seating layout with front-facing and rear-facing seats for versatile passenger capacity.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Maneuverable size perfect for neighborhoods, golf courses, and tight spaces.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Settings className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Electric Performance</h3>
                      <p className="text-gray-600">Efficient electric motor delivers smooth, quiet operation with zero emissions.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Award className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Quality Construction</h3>
                      <p className="text-gray-600">Built with premium materials and components for lasting durability.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Personal Transportation Vehicles today for your EVOLUTION D5-MAVERICK 2+2.
            </p>
