...
export default function EvolutionTurfman1000() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION TURFMAN 1000 Private Transportation Vehicle"
        ...
        <section className="py-16 px-4 bg-theme-primary text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Contact TIGON Private Transportation Vehicles today for commercial pricing, availability, and to schedule a demonstration.
            </p>
