...
export default function EvolutionTurfman1000() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION TURFMAN 1000 Personal Transportation Vehicle"
        ...
        canonicalUrl="https://tigonptv.com/vehicles/evolution-turfman-1000"
        ...
        <section className="py-16 px-4 bg-theme-primary text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Contact TIGON Personal Transportation Vehicles today for commercial pricing, availability, and to schedule a demonstration.
            </p>
