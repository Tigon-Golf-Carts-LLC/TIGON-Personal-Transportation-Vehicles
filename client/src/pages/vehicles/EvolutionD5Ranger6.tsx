...
export default function EvolutionD5Ranger6() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION D5-RANGER 6 Personal Transportation Vehicle"
        description="Six-passenger personal transportation vehicle with rugged construction and reliable performance. Perfect for group transportation and family adventures. Call 1-844-844-6638."
        keywords="EVOLUTION D5 Ranger 6, 6-passenger personal transportation vehicle, group transportation, family NEV, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonptv.com/vehicles/evolution-d5-ranger-6"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Six-passenger personal transportation vehicle with rugged Ranger construction. Perfect for group transportation, family outings, and community events with reliable performance.
                </p>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D5-RANGER 6 Personal Transportation Vehicle"
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Comfortable seating for six adults with ample legroom and support for group transportation.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Heavy-duty frame and suspension built for demanding environments and frequent use.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Dependable electric motor delivers consistent power for daily group transportation.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Designed for families, resorts, and communities needing reliable group transportation.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Group Transportation, Rugged Performance
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Personal Transportation Vehicles today for your EVOLUTION D5-RANGER 6.
            </p>
