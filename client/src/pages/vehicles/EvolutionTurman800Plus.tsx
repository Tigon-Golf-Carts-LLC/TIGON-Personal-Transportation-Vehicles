...
export default function EvolutionTurman800Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION TURMAN 800 PLUS Neighborhood Electric Vehicle"
        description="Mid-size commercial utility neighborhood electric vehicle for landscaping and maintenance work. 800 lbs payload capacity with durable construction. Call 1-844-844-6638."
        keywords="EVOLUTION TURMAN 800 PLUS, mid-size utility vehicle, landscaping cart, commercial NEV, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonnev.com/vehicles/evolution-turman-800-plus"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Mid-size commercial utility neighborhood electric vehicle designed for landscaping and maintenance work. 800 lbs payload capacity with durable construction for demanding applications.
                </p>
                
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-primary">Mid-Size Design</div>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION TURMAN 800 PLUS Commercial Utility Vehicle"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Mid-Size Utility</h3>
                      <p className="text-gray-600">Perfect balance of maneuverability and cargo capacity for landscaping work.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Shield className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">800 lbs Payload</h3>
                      <p className="text-gray-600">Substantial payload capacity for equipment, materials, and supplies.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Settings className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Durable Construction</h3>
                      <p className="text-gray-600">Heavy-duty components built to withstand demanding commercial environments.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Designed for professional landscaping and property maintenance teams.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        ...
                        <span className="drop-shadow-lg">2 operators</span>
                      </div>
                      <div className="flex items-center justify-between py-3 border-b border-gray-200">
                        <div className="flex items-center gap-3">
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Mid-Size Power, Commercial Performance
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Neighborhood Electric Vehicles today for your EVOLUTION TURMAN 800 PLUS.
            </p>
