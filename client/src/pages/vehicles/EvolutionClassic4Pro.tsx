...
import vehicleImage from "@assets/EVOLUTIONCLASSIC4PLUS_1751893115779_1753135231314.jpg";

export default function EvolutionClassic4Pro() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION CLASSIC 4 PRO Neighborhood Electric Vehicle"
        description="Professional grade four-passenger classic neighborhood electric vehicle with enhanced features and premium performance. Timeless design meets modern technology. Call 1-844-844-6638."
        keywords="EVOLUTION CLASSIC 4 PRO, professional neighborhood electric vehicle, 4-passenger, enhanced features, classic design, EVOLUTION dealer nationwide"
        canonicalUrl="https://tigonnev.com/vehicles/evolution-classic-4-pro"
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Professional grade four-passenger classic neighborhood electric vehicle combining timeless design with enhanced performance features. The ultimate in classic styling with modern technology.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-primary">Pro Features</div>
                    <div className="drop-shadow-lg">Enhanced Package</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-primary">Design</div>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION CLASSIC 4 PRO Neighborhood Electric Vehicle"
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-8 drop-shadow-lg">Pro Features</h2>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <Zap className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Professional Performance</h3>
                      <p className="text-gray-600">Enhanced motor and drivetrain delivers superior performance and reliability.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Timeless styling with premium materials and traditional golf cart aesthetics.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">LED lighting, premium audio, and upgraded interior appointments included.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Upgraded seating with enhanced cushioning and support for all passengers.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Classic Style, Professional Performance
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Neighborhood Electric Vehicles today for your EVOLUTION CLASSIC 4 PRO.
            </p>
