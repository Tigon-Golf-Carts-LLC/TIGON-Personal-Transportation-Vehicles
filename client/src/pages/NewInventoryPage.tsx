      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
          <div 
            ...
            style={{backgroundImage: "url('/attached_assets/TIGON%20Personal%20Transportation%20Vehicles%20Premier%20PTV%20Dealership%20-%20PTV%209_1764176674273.jpeg')"}}
          >
        ...
        <section className="py-8 bg-white border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <Button className="bg-theme-orange hover:opacity-90">
                  ...
                  <Card key={vehicle.id} className="overflow-hidden hover:shadow-lg transition-shadow bg-white border border-gray-200">
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button 
                          size="sm" 
                          className="bg-theme-orange hover:opacity-90 text-white px-4 py-2 rounded text-sm font-medium"
                          asChild
                        >
