...
export default function NEVvsElectricCars() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead title={post.seoTitle} description={post.metaDescription} keywords="NEV vs electric car, personal transportation vehicle comparison, NEV range speed, electric car alternative, local transportation Pennsylvania" canonicalUrl={`https://tigonptv.com/blog/${post.slug}`} />
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-theme-primary to-blue-700 text-white rounded-lg text-center">
          ...
          <p className="mb-6">Test drive our personal transportation vehicles and see the difference</p>
