...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      icon: Settings,
      title: "Customization",
      description: "Personalize your personal transportation vehicle with custom accessories and modifications",
      features: [
        "Custom paint jobs",
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead 
        ...
        description="Keep your personal transportation vehicle running perfectly with expert maintenance, repair, and customization services from certified technicians. Professional NEV service for all major brands. Call 1-844-844-6638."
        keywords="personal transportation vehicle service, NEV repair, NEV maintenance, nationwide PA, certified technicians, TIGON"
      ...
      />
      {/* Hero Section */}
      <section className="relative py-20 px-4 bg-gradient-to-r from-theme-primary to-blue-700 text-white bg-cover bg-center bg-no-repeat" style={{backgroundImage: "linear-gradient(rgba(14, 46, 85, 0.8), rgba(29, 78, 216, 0.8)), url('/attached_assets/TIGON%20Personal%20Transportation%20Vehicles%20Premier%20PTV%20Dealership%20-%20PTV%205_1764176674272.jpeg')"}}>
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl font-bold mb-6">Professional NEV Services</h1>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Expert maintenance, repair, and customization services to keep your personal transportation vehicle 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Complete personal transportation vehicle services from certified professionals
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Experience the difference of professional personal transportation vehicle service
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our team is factory-trained and certified to work on all major personal transportation vehicle brands
              </p>
            </div>
      ...
      <section className="py-16 px-4 bg-theme-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">
            Keep your personal transportation vehicle running smoothly with professional service
          </p>
